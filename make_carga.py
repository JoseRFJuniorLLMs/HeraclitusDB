#!/usr/bin/env python3
"""Gera /mnt/d/DEV/HeraclitusDB/reset-e-carga.sh com conteudo bash correto."""
import os, sys

dst = "/mnt/d/DEV/HeraclitusDB/reset-e-carga.sh"
...
os.chmod(dst, 0o755)
print(f"[OK] {dst}")
print(f"     {len(content.splitlines())} linhas")
